...
SECRET_KEY = 'django-insecure-gx0b0ta$xvd^7p@w&ya+l*c)d((5-ib*mb+((*r)u_txi(qrd4'

GEMINI_API_KEY = 'AIzaSyDzHIKbB34f5i67RS_p5q-lAzuiOzhVVlU'
...
# Clear any duplicate configurations
CORS_ALLOW_METHODS = [
    'DELETE',
    'GET',
    'OPTIONS',
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=365*100),  # Set to 100 years effectively making it non-expiring
    'REFRESH_TOKEN_LIFETIME': timedelta(days=365*100),  # Set to 100 years effectively making it non-expiring
